import json
import os
from old_files.utils import DATA_DIR, WORK_DIR

def create_manifest(data_dir, duration, work_dir, output_file_name, 
                    type, url_transcript_text=None, source_lang = "en", target_lang = "en",
                    pnc = "no"):
    manifest_data = []
    ...
    for i, wav_file in enumerate(os.listdir(data_dir)):
        if wav_file.endswith('.wav'):
            ...
            if type == "asr":
                ...
                "taskname":"asr", "source_lang": source_lang, "target_lang": target_lang,
                "pnc": pnc, "answer": "na"}
...
if __name__ == "__main__":
    ...
    #                  work_dir=WORK_DIR)
    create_manifest(data_dir=DATA_DIR, duration=None, work_dir=WORK_DIR, output_file_name='dataset_manifest', 
                    type='asr', url_transcript_text=None, source_lang = "en", target_lang = "en",
                    pnc = "no")