...
parse_parameters() {
    local parsed_args
    parsed_args=$(getopt -o m:d:p:o:t:c:b:r:s:h \
                --long model-path:,dataset-manifest:,pretrained-name:,output-dir:,total-buffers:,chunk-lengths:,batch-sizes:,model-stride:,sleep-time:,help \
