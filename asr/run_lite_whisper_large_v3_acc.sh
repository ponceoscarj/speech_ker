...
# Example Usage:
# bash run_lite_whisper_large_v3_acc.sh -m /models/lite_whisper_large_v3_acc -i /audio_files \
#     -o /output -c "20 30" -b "2 4" -t "none" -e ".wav"
#
# bash run_lite_whisper_large_v3_acc.sh \
#   --main_model /home/ext_alzahidy_misk_mayo_edu/speech_ker/asr/models/lite_whisper_large_v3-acc \
#   --processor_model /home/ext_alzahidy_misk_mayo_edu/speech_ker/asr/models/whisper_large_v3 \
...
run_experiment() {
...

    {
        ...
        python -u lite_whisper_large_v3_acc.py \
            --input_dir "${input_dir}" \
